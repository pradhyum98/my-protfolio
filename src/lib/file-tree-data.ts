      ...
      children: [
        {
          ...
          id: "viz-powerbi",
          name: "power-bi.json",
          path: "/skills/visualization/power-bi.json",
          ext: "json",
          preview: {
            type: "skill",
        ...
        },
        {
          ...
          id: "viz-excel",
          name: "excel.json",
          path: "/skills/visualization/excel.json",
          ext: "json",
          preview: {
            type: "skill",
            category: "visualization",
      ...
      children: [
        {
          ...
          id: "eng-sql",
          name: "sql.json",
          path: "/skills/engineering/sql.json",
          ext: "json",
          preview: {
            type: "skill",
        ...
        },
        {
          ...
          id: "eng-python",
          name: "python.json",
          path: "/skills/engineering/python.json",
          ext: "json",
          preview: {
            type: "skill",
            category: "engineering",
      ...
      children: [
        {
          ...
          id: "analytics-dax",
          name: "dax.json",
          path: "/skills/analytics/dax.json",
          ext: "json",
          preview: {
            type: "skill",
            category: "analytics",
        ...
        },
        {
          ...
          path: "/skills/analytics/statistics.json",
          ext: "json",
          preview: {
            type: "skill",
            category: "analytics",
...
export const contactFileTree: FileTreeNode = {
  ...
  children: [
    ...
    },
    {
      ...
      action: {
        kind: "link",
        href: "https://www.linkedin.com/in/pradhyum-upadhyay-b26263240/",
        external: true,
      },
    },
    {
