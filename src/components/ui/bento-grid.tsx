  ...
  return (
    <div
      className={cn(
        ...
        "[grid-auto-rows:var(--tile)] [--tile:16rem] sm:[--tile:18rem] lg:[--tile:20rem]",
        className
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  >
    ...
    <div
      className={cn(
        "pointer-events-none absolute bottom-0 z-10 hidden w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 lg:flex"
      )}
    >
      <Button
        variant="link"
    ...
    <div className="pointer-events-none absolute inset-0 z-[5] transform-gpu transition-all duration-300 group-hover:bg-black/[.03] group-hover:dark:bg-neutral-800/10" />
  </div>
)
